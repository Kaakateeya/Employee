...
FusionCharts.register("module", ["private", "modules.renderer.js-charts", function() {
        function Ka(a) { var n = { left: a.offsetLeft, top: a.offsetTop }; for (a = a.offsetParent; a;) n.left += a.offsetLeft, n.top += a.offsetTop, a !== Ta.body && a !== Ta.documentElement && (n.left -= a.scrollLeft, n.top -= a.scrollTop), a = a.offsetParent; return n }

        function Aa(a, n) { for (var e = [], d = 0, v = a.length; d < v; d++) e[d] = n.call(a[d], a[d], d, a); return e }

        function oa(a, n) { var e = n ? 360 : xa;
            a = (a || 0) % e; return 0 > a ? e + a : a }
        ...
        function Ua(a, n, e, d, v) { return r((n - e[1] - d.top) / v, a - e[0] - d.left) }
        ...
        p("pie2d", {
            ...
            point: function(a, n, e, d, v) {
                ...
                for (y = t.length - 1; 0 <= y; --y) {
                    ...
                    void 0 !== A ? A = Na(A, [1,
                        2, 3, 5, 6, 7, 14, 24, 25
                    ], { formattedValue: fa, label: M, yaxisName: pa(d.yaxisname), xaxisName: pa(d.xaxisname), percentValue: N, sum: ja.dataLabels(x), unformattedSum: x }, l, d) : (A = M, Q = p ? N : fa, A = A != ca ? A + F + Q : Q);
                    Q = Sa ? M : ca;
            ...
            containsMacro: function(a, n) { for (var e = n.length || 0, d; e--;)
                    if (d = new RegExp(n[e], "gi"), d = a.match(d)) return !0;
                return !1 },
            getPointColor: function(a, n, e) { var d, v;
                a = ma(a);
                n = ua(n);
                100 > e && qa ? (d = Math.floor(85 * (100 - .35 * e)) / 100, d = ea(a, d), v = Math.floor(50 * (100 + e)) / 100, a = ga(a, v), n = { FCcolor: { color: a + Y + d, alpha: n + Y + n, ratio: e + "," + (100 - e), radialGradient: !0, gradientUnits: "userSpaceOnUse" } }) : n = { FCcolor: { color: a + Y + a, alpha: n + Y + n, ratio: "0,100" } }; return n },
            configureAxis: function(a,
                ...
                if (1 === a.series.length &&
                    ...
                    for (; e--;) c[e] && void 0 !== Fa(c[e].displayValue) && d.push({ text: c[e].displayValue, style: c[e].style })
            },
            ...
            creditLabel: na,
            eiMethods: {
                isPlotItemSliced: function(a) { var n = this.jsVars.hcObj,
                        e, d, v; return n && n.datasets && n.datasets[0] && (e = n.datasets[0].data) && (v = e.length) && e[a = v - a - 1] && (d = e[a].plot) && d.sliced },
                slicePlotItem: function(a, n) { var e = this.jsVars.hcObj,
                        d, v, b, w; return e && e.datasets && (d = e.datasets[0]) && (v = d.data) && (w = v.length) && v[a = d.reversePlotOrder ? a : w - a - 1] && (b = v[a].plot) && ((!!n !== b.sliced || void 0 === n) && e.plotGraphicClick.call(b) || b.sliced) },
        ...
        p.pie2d.eiMethods.enableSlicingMovement = p.pie2d.eiMethods.enablelink = function() { va.raiseWarning(this, "1301081430", "run", "JSRenderer~enablelink()", "Method deprecated.") };
        p("pie3d", {
        ...
        p("doughnut2d", { friendlyName: "Doughnut Chart", getPointColor: function(a, n, e) { var d;
                a = ma(a);
                n = ua(n);
                100 > e && qa ? (d = ea(a, t(100 * (85 - .2 * (100 - e))) / 100), a = ga(a, t(100 * (100 - .5 * e)) / 100), n = { FCcolor: { color: d + "," + a + "," + a + "," + d, alpha: n + "," + n + "," + n + "," + n, radialGradient: !0, gradientUnits: "userSpaceOnUse", r: e } }) : n = { FCcolor: { color: a + "," + a, alpha: n + "," + n, ratio: "0,100" } }; return n } }, p.pie2d);
        p("doughnut3d", {
        ...
        p("pareto2d", {
            ...
            point: function(a, n, e, d, v) {
                ...
                a = J.length;
                J.sort(function(a, e) { return e.value - a.value });
                ...
                for (O = 0; O < a; O += 1) la = J[O], B = k(la.showlabel, d.showlabels, 1), e = pa(B ? Oa(la.label, la.name) : ca), I = q(la.color, V.getPlotColor()), ja.addXaxisCat(F, O, O, e, la, {}, d, I), b += y = la.value, Q = k(la.dashed, g), Z = q(la.dashgap, x), z = q(la.dashlen, K), G = q(la.alpha, d.plotfillalpha, Qa), N = q(la.ratio, d.plotfillratio), B = { opacity: G / 100 }, Pa = q(la.alpha, l) + ca, ia = ra(I + Y + E.replace(/,+?$/, ""), G, N, m, h, C + ca, Pa + ca, X, u), R = Q ? La(z, Z, f) : "none", ea = b / w * 100, xa = H.percentValue(ea),
                    ba = null === y ? y : W.dataLabels(y), da = Fa(pa(la.displayvalue)), aa = k(la.showvalue, sa.showValues) ? void 0 !== da ? da : ba : ca, P = q(da, ba, ca), sa.showTooltip ? void 0 !== (da = Fa(pa(q(la.tooltext, sa.tooltext)))) ? (ha = { formattedValue: ba, label: e, yaxisName: A, xaxisName: t, cumulativeValue: b, cumulativeDataValue: W.dataLabels(b), cumulativePercentValue: xa, sum: W.dataLabels(w), unformattedSum: w }, Ga = [1, 2, 3, 5, 6, 7, 20, 21, 22, 23, 24, 25], da = Na(da, Ga, ha, la, d)) : da = null === ba ? !1 : e !== ca ? e + sa.tooltipSepChar + ba : ba : da = ca, Z = this.pointHoverOptions(la,
                        n, { plotType: "column", is3d: u, isBar: X, use3DLighting: D, isRoundEdged: h, color: I, gradientColor: E, alpha: G, ratio: N, angle: m, borderWidth: f, borderColor: C, borderAlpha: Pa, borderDashed: Q, borderDashGap: Z, borderDashLen: z, shadow: B }), Q = q(la.link), n.data.push({
                        link: Q,
                        toolText: da,
                        displayValue: aa,
                        displayValueArgs: P,
                    ...
                    if (g)
                        for (K =
                            ...
                            for (F = 0; F < c.length; F += 1)
                                if (a.series[F].visible = !0, R = a.series[F].data[K], R._FCX = V, R._FCW = T, E = q.percentValue(R.y / A * 100), R.toolText = Na(R.toolText, [14, 24, 25, 111, 112], { xAxisPercentValue: q.percentValue(T), percentValue: E, sum: q.dataLabels(A), unformattedSum: A }), wa) {
                            ...
                            e.showXAxisPercentValues && K < U && a.xAxis.plotLines.push({
                                ...
                                label: {
                                    ...
                                    style: { color: ja.color, fontSize: ja.fontSize, fontFamily: ja.fontFamily, lineHeight: ja.lineHeight },
                                    verticalAlign: fa,
                                    y: p,
                                    x: C,
            ...
            series: function(a, n, e) {
                ...
                if (a.dataset && 0 < a.dataset.length) {
                    ...
                    if (this.isDual && a.lineset && 0 < a.lineset.length)
                        for (b = 0, w = a.lineset.length; b < w; b += 1, V += 1) d = a.lineset[b], u = { hoverEffects: this.parseSeriesHoverOptions(a, n, d, e), visible: !k(d.initiallyhidden, 0), data: [], yAxis: 1, type: "line" }, X = Math.min(c.oriCatTmp.length, d.data && d.data.length), n.series.push(p.msline.point.call(this, "msline", u, d, a.chart, n, X, V));
                    this.configureAxis(n,
                        a);
                    a.trendlines && $a(a.trendlines, n.yAxis, n[ta], this.isDual, this.isBar)
                }
            },
            postSpaceManager: function(a, n, e) { var d = a[ta],
                    b, c, w;
                p.base.postSpaceManager.call(this); if (this.isStacked && d.showStackTotal && (b = a.chart, a = (n = a.xAxis) && n.plotLines, b = e - b.marginLeft - b.marginRight, e = d.plotSpacePercent, d = d[0].stack, d = d.column && d.column.length, c = (1 - 2 * e) / d, n = b / (n.max - n.min), 50 < n * c && .1 == e))
            ...
            series: function(a, n, e) {
                ...
                if (a.dataset && 0 < a.dataset.length) {
                    ...
                    for (b = a.dataset.length; d < b; d += 1)
                        if (m = a.dataset[d].dataset)
                            for (c = 0, w = m.length; c < w; c += 1, V += 1) u = { hoverEffects: this.parseSeriesHoverOptions(a, n, m[c], e), visible: !k(m[c].initiallyhidden, 0), data: [], numColumns: b, columnPosition: d }, X = Math.min(f.oriCatTmp.length, m[c].data &&
                                m[c].data.length), u = this.point(e, u, m[c], a.chart, n, X, V, d), n.series.push(u);
                    if (this.isDual && a.lineset && 0 < a.lineset.length)
                        for (c = 0, w = a.lineset.length; c < w; c += 1, V += 1) d = a.lineset[c], u = { hoverEffects: this.parseSeriesHoverOptions(a, n, d, e), visible: !k(d.initiallyhidden, 0), data: [], yAxis: 1, type: "line" }, X = Math.min(f.oriCatTmp.length, d.data && d.data.length), n.series.push(p.msline.point.call(this, "msline", u, d, a.chart, n, X, V));
        ...
        p("mscombi3d", {
            ...
            eiMethods: function(a) {
                var n = {};
                Ea(a.split(","), function(a) { n[a] = function() { va.raiseWarning(this, "1301081430", "run", "JSRenderer~" + a + "()", "Method not applicable.") } });
                return n
        ...
        p("scrollstackedcolumn2d", {
            ...
            postSeriesAddition: function(a, n, e, d) { p.base.postSeriesAddition.call(this, a, n, e, d);
            ...
            chart: function(a, b) {
                ...
                var e = {
                        ...
                        chart: {
                            ...
                            style: { fontFamily: q(v.basefont, "Verdana,sans"), fontSize: Xa(v.basefontsize, 20) + Za, color: q(v.basefontcolor, l.getColor("baseFontColor")).replace(/^#?([a-f0-9]+)/ig, "#$1") },
                        ...
                        credits: { href: L.CREDIT_HREF, text: L.CREDIT_STRING, enabled: na },
                        legend: { enabled: !1 },
                        series: [],
                        subtitle: { text: ca },
                        title: { text: ca },
                ...
                X.setStyle(Z);
                for (w = 0; w < u; w += 1)
                    if (F = V[w], z = m.getCleanValue(F.value), M = pa(Oa(F.label, F.name)), wa = ma(q(F.color, l.getPlotColor())), q(F.alpha, v.plotfillalpha, Qa), M != ca || null != z) f.push({ value: z, label: M, color: wa }), fa += z, r += 1;
        ...
        p("renderer.bubble", {
            drawPlotBubble: function(a, n) {
                var e = this,
                    ...
                    h = { fontFamily: w.fontFamily, fontSize: w.fontSize, lineHeight: w.lineHeight, fontWeight: w.fontWeight, fontStyle: w.fontStyle },
                    w = e.paper,
                    V = e.elements,
                    u = a.items,
                ...
                var fa = t.tracker,
                    r, M, y = function(a) { Ca.call(this, e, a) },
                    O = function(a, d, b) { return function(n) { a.attr(d);
                            Ca.call(this, e, n, b) } };
        ...
        p("renderer.ssgrid", {
            ...
            drawSSGridNavButton: function() {
                ...
                1 < c.length && (k = a.naviigator =
                    b.group("navigation"), a.navElePrv = c = b.group(k), u = b.path(["M", 20, V, "L", 20 + e + h, V - h, 20 + e, V, 20 + e + h, V + h, "Z"]).attr({ fill: f, "stroke-width": 0, cursor: "pointer" }), c.appendChild(u), m = b.circle(20 + e, V, e).attr({ fill: ia, "stroke-width": 0, cursor: "pointer" }).mouseover(function() { u.attr({ fill: w, cursor: "pointer" }) }).mouseout(function() { u.attr({ fill: f }) }).click(function() { a.nenagitePage(-1) }), c.appendChild(m), a.navEleNxt = c = b.group(k), X = b.path(["M", d, V, "L", d - e - h, V - h, d - e, V, d - e - h, V + h, "Z"]).attr({
                        fill: f,
                        "stroke-width": 0,
                        cursor: "pointer"
                    }), c.appendChild(X), b = b.circle(d - e, V, e).attr({ fill: ia, "stroke-width": 0, cursor: "pointer" }).mouseover(function() { X.attr({ fill: w }) }).mouseout(function() { X.attr({ fill: f }) }).click(function() { a.nenagitePage(1) }), c.appendChild(b))
            },
            nenagitePage: function(a) {
                var b = this.plots,
                    e = b.length;
                a = (this.currentSeriesIndex || 0) + (a || 0);
                var d, c = function(a) { a.graphic && a.graphic.hide();
                ...
                if (b[a]) { for (d = e; d--;) Ea(b[d].items, c);
                    Ea(b[a].items, function(a) { a.graphic && a.graphic.show();
        ...
        Wa.prototype = {
            getArcPath: function(a, b, e, d, c, f, w, h, V, u) { return e == c && d == f ? [] : ["A", w, h, 0, u, V, c, f] },
            parseColor: function(a, b) {
                ...
                return {
                    frontOuter: { FCcolor: { gradientUnits: "userSpaceOnUse", x1: this.leftX, y1: 0, x2: this.rightX, y2: 0, color: c, alpha: C, angle: 0, ratio: "0,20,15,15,50" } },
                    backOuter: { FCcolor: { gradientUnits: "userSpaceOnUse", x1: this.leftX, y1: 0, x2: this.rightX, y2: 0, color: u, alpha: p, angle: 0, ratio: "0,62,8,8,22" } },
                    frontInner: {
                        FCcolor: {
                    ...
                    backInner: { FCcolor: { gradientUnits: "userSpaceOnUse", x1: this.leftInnerX, y1: 0, x2: this.rightInnerX, y2: 0, color: R, alpha: C, angle: 0, ratio: "0,62,8,8,22" } },
                    topBorder: { FCcolor: { gradientUnits: "userSpaceOnUse", x1: this.leftX, y1: 0, x2: this.rightX, y2: 0, color: f, alpha: g, angle: 0, ratio: "0,20,15,15,50" } },
                    topInnerBorder: { FCcolor: { gradientUnits: "userSpaceOnUse", x1: this.leftInnerX, y1: 0, x2: this.rightInnerX, y2: 0, color: f, alpha: g, angle: 0, ratio: "0,50,15,15,20" } },
                    top: qa ? {
                        FCcolor: {
                            gradientUnits: "userSpaceOnUse",
                            radialGradient: !0,
                    ...
                    } : { FCcolor: { gradientUnits: "objectBoundingBox", color: V + Y + V + Y + h + Y + d, alpha: b + Y + b + Y + b + Y + b, angle: -72, ratio: "0,8,15,77" } },
                    bottom: P(aa(a, k)),
                    startSlice: P(aa(e, b)),
                    endSlice: P(aa(e, b))
                }
            },
            rotate: function(a) { if (!this.hasOnePoint) { for (var b = this.pointElemStore, e = 0, d = b.length, c; e < d; e += 1) c = b[e], c = c._confObject, c.start += a, c.end += a, this.updateSliceConf(c);
                    this.refreshDrawing() } },
            refreshDrawing: function() {
                return function() {
                    ...
                    a: { var X = a[0] && a[0]._conf.index,
                            m, g;h = X <= Q;c = 1; for (e = a.length; c < e; c += 1)
                            if (g = a[c]._conf.index, m = g <= Q, m != h || g < X) break a;c = 0 }
            ...
            createSlice: function() {
                var a = {
                    ...
                    b = function(b, e) {
                        ...
                        if (b && "string" !== typeof b) {
                            ...
                            for (d in b)
                                if (c = b[d], a[d])
                                    if (f[d] = c, "ishot" === d || "cursor" === d) { v = {};
                                        v[d] = c; for (h in g) g[h].attr(v);
                                        n._attr(v) } else if ("transform" === d) { for (h in g) g[h].attr({ transform: b[d] });
                                n._attr({ transform: b[d] }) } else "stroke" === d || "strokeWidth" ===
                    ...
                    e = function(a, b, d, e) { var c = this._confObject.elements,
                            n; for (n in c)
                            if (d) c[n].drag(b, d, e);
                            else c[n].on(a, b);
                    ...
                    c = function() { var a = this._confObject.elements,
                ...
                return function(a, g, h, u, l, m, p, k, R, C) {
                    ...
                    qa ? (C = { fill: P(h.top), "stroke-width": 0 }, 1 !== R && (C.stroke = l, C["stroke-width"] = m), C = t[r](a.clipTopPath, this.topGroup).attr(C), R && (u.topBorder = t[r](a.clipTopBorderPath, this.topGroup).attr({
                        fill: P(h.topBorder),
                        "stroke-width": 0
                    }))) : (C = t[r](a.clipTopPath, this.topGroup).attr({ fill: P(h.top), "stroke-width": 0 }), u.topBorder = t[r](a.clipTopBorderPath, this.topGroup).attr({ stroke: l, "stroke-width": m }));
                    ...
                    m = oa(a.end);
                    R = (l > m ? xa : 0) + m - l;
                    R > Q && (u.frontOuter1 = t[r](a.clipOuterFrontPath1, this.slicingWallsFrontGroup).attr({ fill: P(h.frontOuter), "stroke-width": 0 }), u.frontOuter1._conf = { index: l, isStart: .5, pIndex: p }, qa && (a.clipOuterFront1 = a.clipOuterFrontPath1));
                    ...
                    if (void 0 !== k) { for (U in u) u[U].tooltip(k);
                        C.tooltip(k) }
        ...
        p("renderer.pie3d", {
            ...
            translate: function() {
                ...
                r = Aa(r, function(a, b) { return (z = /%$/.test(a)) ? [p, u - g, F, F][b] * parseInt(a, 10) / 100 : a });
                r[2] /= 2;
                r[3] /= 2;
                r.push(r[2] * P);
                r.push((r[2] + r[3]) / 2);
            ...
            drawPlotPie3d: function(a, b) {
                ...
                var c = this,
                    ...
                    fa = function(a) { return function() { c.legendClick(a, !0, !1) } },
                    I = function(a) { return function() { return c.getEventArgs(a) } },
                    N = function(a) { return function(b, d, c, e, n) { A.call(a, b, d, c, e, n) } },
                    K = function(a) { return function(b, d, c) { F.call(a, b, d, c) } },
                    S = function(a) { return function(b) { B.call(a, b) } },
                    T = function(a) { return function(b) { W.call(a, b) } },
                    G = function(a) { return function(b) { E.call(a, b) } },
                ...
                }, b.data[Y].legendClick = fa(M), b.data[Y].getEventArgs = I(M), M.graphic.plotItem = M, M.graphic.data("plotItem", M), M.transX = U(da) * q, M.transY = R(da) * C, M.slicedTranslation = "t" + M.transX + "," + M.transY, da = { index: b.reversePlotOrder ? Y : J - 1 - Y, link: y.link, value: y.y, displayValue: y.displayValueArgs, categoryLabel: y.categoryLabel, isSliced: y.sliced, toolText: y.toolText }, M.graphic.attr({
                    transform: "t" + M.slicedX + "," + M.slicedY,
                    ishot: ea,
                    cursor: ba ?
                        "pointer" : ""
                }).drag(N(M), K(M), S(M)).data("groupId", Y).data("eventArgs", da).mouseover(G(M)).mouseout(T(M)), void 0 !== O && (m = y.style, H = { fontFamily: m.fontFamily, fontSize: m.fontSize, lineHeight: m.lineHeight, fontWeight: m.fontWeight, fontStyle: m.fontStyle }, M.dataLabel = t.text(p.dataset).css(H).attr({
                    text: O,
            ...
            plotRollOver: function(a) { var b = this.chart,
            ...
            plotDragStart: function(a, b, c) { var d = this.seriesData,
            ...
            plotDragEnd: function(a) {
                var b = this.chart,
                    ...
                    f = c.startAngle,
                    g = this.seriesData,
                    h = { hcJSON: { series: [{ startAngle: f }] } };
                b.disposed || Ba(b.logic.chartInstance.jsVars._reflowData, h, !0);
                !g.isRotating && b.plotGraphicClick.call(this,
                    a);
                g.isRotating && (setTimeout(function() { g.isRotating = !1 }, 0), va.raiseEvent("rotationEnd", { startingAngle: oa(f, !0), changeInAngle: f - c.startingAngleOnDragStart }, b.logic.chartInstance), !b.isHovered && d.colorObjs[this.index] && d.onPlotHover(this.index, !1))
            },
            plotDragMove: function(a, b, c, d, f) {
                var g = this.chart;
                a = g.datasets[0];
                b = this.seriesData;
                g.options.series[0].enableRotation && !b.singletonCase && (c = Ua.call(f, c, d, b.pieCenter, b.chartPosition, a.pieYScale), b.isRotating || (a.dragStartAngle !== c && (b.isRotating = !0), va.raiseEvent("rotationStart", { startingAngle: oa(a.startAngle, !0) }, g.logic.chartInstance)), d = c - a.dragStartAngle, a.dragStartAngle = c, b.moveDuration = 0, a._lastAngle += 180 * d / da, c = (new Date).getTime(), !a._lastTime || a._lastTime + b.timerThreshold < c) && (a._lastTime || g.rotate(), b.timerId = setTimeout(function() { g.disposed && g.disposing || g.rotate() }, b.timerThreshold), a._lastTime = c)
            },
            animate: function(a, b) {
                var c, d, f, g = a.length,
                    h, l, p, u = this,
                    k, m = function() { u.disposed || u.disposing || u.placeDataLabels(!1, a) };
                if (u.datasets[0].alphaAnimation) u.layers.dataset.attr({ opacity: 0 }),
                    u.layers.dataset.animate({ opacity: 1 }, b, "ease-in", function() { u.disposed || u.disposing || u.placeDataLabels(!1, a) });
                else
                    for (c = 0; c < g; c++) h = a[c], l = h.graphic, p = h.shapeArgs, h = 2 * da, l && (l.attr({ start: h, end: h }), k = p.start, p = p.end, d ? l.animateWith(d, f, { cx: k - h, cy: p - h }, b, "ease-in") : (f = ka.animation({ cx: k - h, cy: p - h }, b, "ease-in", m), d = l.animate(f)))
            },
            placeDataLabels: function() {
                var a = function(a, b) { return a.point.value - b.point.value },
                    b = function(a, b) { return a.angle - b.angle },
                ...
                return function(p, r) {
                    ...
                    p || q.setStyle(B);
                    if (1 == r.length) y = r[0], na = y.dataLabel, y.slicedTranslation = [K, S], na && (na.attr({ visibility: f, "text-anchor": "middle", x: ea, y: Y + pa - 2 }), na.x = ea);
                    else if (W) Ea(r, function(a) { if (na = a.dataLabel) { ha = a.angle;
                            ma = Y + da[6] * R(ha) + pa - 2;
                            ra = ea + da[5] * U(ha);
                            na.x = ra;
                            na._x = ra;
                            na.y = ma; if (a.sliced) { a = a.slicedTranslation; var b = a[1] - S;
                                ra += a[0] - K;
                                ma += b }
                            na.attr({ visibility: f, align: "middle", x: ra, y: ma }) } });
                    else {
                        Ea(r, function(a) { if (na = a.dataLabel) ha = a.angle, 0 > ha && (ha = xa + ha), la = 0 <= ha && ha < Pa ? 1 : ha < Q ? 2 : ha < ba ? 3 : 0, H[la].push({ point: a, angle: ha }) });
                        for (aa = W = 4; aa--;) { if (z && (y = H[aa].length - qa, 0 < y))
                                for (H[aa].sort(a), L = H[aa].splice(0, y), ia = 0, M = L.length; ia < M; ia += 1) y = L[ia].point, y.dataLabel.attr({ visibility: "hidden" }), y.connector && y.connector.attr({ visibility: "hidden" });
                            H[aa].sort(b) }
        ...
        p("renderer.pie", {
            drawDoughnutCenterLabel: function(a, b, c, d, g, h, l) {
                ...
                var k = this.paper,
                    ...
                    t = h.padding,
                    R = 2 * h.textPadding,
                    U = { fontFamily: h.font, fontSize: h.fontSize + "px", lineHeight: 1.2 * h.fontSize + "px", fontWeight: h.bold ? "bold" : "", fontStyle: h.italic ? "italic" : "" },
                    C = 1.414 * (.5 * d - t) - R;
                g = 1.414 * (.5 * g - t) - R;
                var x;
                u.setStyle(U);
                ...
                a ? (g.css(U).attr({
                    ...
                    fill: P({ FCcolor: { color: h.color, alpha: h.alpha } }),
                    "text-bound": h.bgOval ? "none" : [P({
                        FCcolor: {
                            color: h.bgColor,
                            alpha: h.bgAlpha
                        }
                    }), P({ FCcolor: { color: h.borderColor, alpha: h.borderAlpha } }), h.borderThickness, h.textPadding, h.borderRadius]
                }).tooltip(h.toolText || u.tooltext), h.bgOval && x && x.attr({ visibility: f, fill: cb(h.bgColor), "fill-opacity": h.bgAlpha / 100, stroke: cb(h.borderColor), "stroke-width": h.borderThickness, "stroke-opacity": h.borderAlpha / 100 })) : (g.attr("visibility", "hidden"), x && x.attr("visibility", "hidden"));
            ...
            centerLabelChange: function(a) { var b = this.fusionCharts;
            ...
            hoverOffCenterLabel: function() { var a = this.chart.options.series[0].lastCenterLabelConfig;
            ...
            drawPlotPie: function(a, b) {
                var c = this,
                    ...
                    ga, ma, ua, na, Ga, Pa = function(a) { return function() { c.legendClick(a, !0, !1) } },
                    pa = function(a) { return function() { return c.getEventArgs(a) } },
                    oa = function() { c.disposed || c.disposing || c.paper.ca.redrawDataLabels || (c.placeDataLabels(!1, d, a), c.paper.ca.redrawDataLabels = c.redrawDataLabels) };
                h && S || (h = []);
...
FusionCharts.register("module", ["private", "modules.renderer.js-zoomline", function() {
    ...
    Ua("zoomline", {
        ...
        chart: function() {
            ...
            va(k, {
                ...
                crossline: {
                    ...
                    labelstyle: { fontSize: Da(f.crosslinelabelsize) ? Da(f.crosslinelabelsize) + "px" : c.outCanvasStyle.fontSize, fontFamily: ka(f.crosslinelabelfont, c.outCanvasStyle.fontFamily) },
                    valueEnabled: z(f.showcrosslinevalues, f.showcrossline, 1),
                    valuestyle: { fontSize: Da(f.crosslinevaluesize) ? Da(f.crosslinevaluesize) + "px" : c.inCanvasStyle.fontSize, fontFamily: ka(f.crosslinevaluefont, c.inCanvasStyle.fontFamily) }
                },
        ...
        preSeriesAddition: function() {
            ...
            g = G.length || 0;
            if (L = !q && x && 0 !== l && g || 0) { for (; L--;) G[L] = G[L] && (N = G[L].label || "") && ((ba = N.length) > Q && (Q = ba, P = L, N) || N) || "";
                Q && (N = G[P]) } else if (q && g && !l)
                if (E) {
        ...
        seriesGraphicsAttrs: function(b) {
            ...
            return {
                graphics: f,
                pin: h,
                shadow: { opacity: f["stroke-opacity"], apply: z(c.showshadow, +!k.vml) },
                anchors: {
                    "stroke-linejoin": "round",
                    "stroke-linecap": "round",
                ...
                anchorShadow: z(c.anchorshadow, c.showshadow, +!k.vml) && { apply: !0, opacity: z(b.anchoralpha, c.anchoralpha, 100) / 100 }
            }
        },
        eiMethods: {
            zoomOut: function() { var b = this.jsVars,
                    c; if (b && (c = b.hcObj)) return c.zoomOut && b.hcObj.zoomOut() },
            zoomTo: function(b, c) { var f = this.jsVars,
                    h; if (f && (h = f.hcObj)) return h.zoomRange && f.hcObj.zoomRange(b, c) },
            resetChart: function() { var b = this.jsVars,
                    c;
                b && (c = b.hcObj) && (c.pinRangePixels && b.hcObj.pinRangePixels(), c.resetZoom && b.hcObj.resetZoom()) },
            setZoomMode: function(b) { var c = this.jsVars,
                    f;
            ...
            getViewEndIndex: function() { var b = this.jsVars,
                    c; if (b && b.hcObj && (c = b.hcObj._zoominfo)) return b = c.ddei - 1, (b >= c.clen ? c.clen : b) - 1 }
        }
    }, Ua.msline);
    ...
    Wa("renderer.zoomline", {
        ...
        zoomOut: function() { var b = this._zoomhistory.pop(),
                c = this.options.stepZoom,
                f, h, k;
            b ? (f = b.dsi, h = b.dei) : this._prezoomed && (f = 0, h = c.clen - 1);
            (k = this.zoomTo(f, h)) && Ka.raiseEvent("zoomedout", k, this.fusionCharts); return !0 },
        zoomRangePixels: function(b, c) { var f = this._zoomhistory,
                h = this._zoominfo,
                k = h.ppp,
                h = h.ddsi,
                q;
        ...
        getValuePixel: function(b) { var c = this._zoominfo; return c.ddsi + P(b / c.ppp) },
        ...
        drawGraph: function() {
            ...
            ha.clen && (Q = b._prezoomed = ha.dei - ha.dsi < ha.clen - 1, ma = b._visw = b.canvasWidth - 2 * x.canvasPadding, ca = b._visx =
                ...
                N.wrap, b.xlabels.rotate = N.rotate, b.xlabels.data = N.data || [], b.xlabels.parsed = [], b.xlabels.css = N.css, b.xlabels.group = c.group("zoomline-plot-xlabels", I.datalabels), I.datalabels.transform(["T", ca, h + U + x.scrollHeight + x.labelPadding]), b._lcmd = N.rotate ? "y" : "x", G && (G = k.crispBound(0, h - ka, 0, U, A), L = g["clip-pinrect"] = [G.x, h, G.width, G.height], P = I.zoompin = c.group("zoompin").insertBefore(r).transform(b._pingrouptransform = ["T", ca, ka]).hide(), g.pinrect = c.rect(0, h - ka, b._visw, U, I.zoompin).attr({
                    ...
                    ishot: !0
                }), g.pintracker = c.rect(I.tracker).attr({ transform: P.transform(), x: 0, y: h - ka, width: 0, height: U, stroke: "none", fill: ta, ishot: !0, cursor: k.svg && "ew-resize" || "e-resize" }).drag(function(b) {
                    ...
                    this.__pindragoffset =
                        b
                }, function() { this.__pinboundleft = 0 - L[0] + ca + f;
                    this.__pinboundright = this.__pinboundleft + ma - L[2];
                    this.data("cliprect", P.attr("clip-rect"));
                    P._.clipispath = !0 }, function() { P._.clipispath = !1;
                    this.__pindragdelta = this.__pindragoffset;
                    delete this.__pindragoffset;
                    delete this.__pinboundleft;
                    delete this.__pinboundright }), b.pinButton = t.add("pinModeIcon", function() { b.activatePin(!b._zoominfo.pinned) }, { tooltip: E && x.btnSwitchToPinModeTooltext || "" })), A++, G = k.crispBound(f - A, h + U + A, q + A + A, x.scrollHeight, A), A--, g.zoomscroller =
                c.scroller(G.x + (l && -1 || A % 2), G.y - (l && 4 || 2), G.width - (!l && 2 || 0), G.height, !0, { showButtons: x.scrollShowButtons, scrollRatio: ha.vdl / (ha.clen - !!ha.clen), scrollPosition: [ha.dsi / (ha.clen - ha.vdl - 1), !1], displayStyleFlat: x.scrollBarFlat }, ba).attr({ fill: x.scrollColor, r: l && 2 || 0 }).scroll(b.updatePlotZoomline, b), l && g.zoomscroller.shadow(!0),
                function() {
                    var c;
                    k.eve.on("raphael.scroll.start." + g.zoomscroller.id, function(f) { c = f;
                        b.crossline && b.crossline.disable(!0);
                        Ka.raiseEvent("scrollstart", { scrollPosition: f }, b.logic.chartInstance) });
                    k.eve.on("raphael.scroll.end." + g.zoomscroller.id, function(f) { b.crossline && b.crossline.disable(!1);
                        Ka.raiseEvent("scrollend", { prevScrollPosition: c, scrollPosition: f }, b.logic.chartInstance) })
                }(), $a(b, { attr: { stroke: x.zoomPaneStroke, fill: x.zoomPaneFill, strokeWidth: 0 }, selectionStart: function() {}, selectionEnd: function(c) { var h = c.selectionLeft - f;
                        c = h + c.selectionWidth;
                        b.crossline && b.crossline.hide();
                        b[b._zoominfo.pinned ? "pinRangePixels" : "zoomRangePixels"](h, c) } }), b.zoomOutButton = t.add("zoomOutIcon", function() { b.zoomOut() }, { tooltip: E && x.btnZoomOutTooltext || "" })[Q && "show" || "hide"](), b.resetButton = t.add("resetIcon", function() { b.resetZoom() }, { tooltip: E && x.btnResetChartTooltext || "" }).hide(), G = b.resetButton.attr("fill"), G[2] = "rgba(255,255,255,0)", b.resetButton.attr("fill", [G[0], G[1], G[2], G[3]]), z && 0 !== z.enabled && 1 === x.useCrossline && (b.crossline = new Ca(b, z)), b.updatePlotZoomline())
        },
        ...
        updatePlotZoomline: function(b, c) {
            ...
            x.trackTooltip(!0);
            if (h > N)
                for (t = N, N = h; t < N; t++)(E = q[t]) && E.show() || (q[t] = f.text(0, 0, "", x).css(r).attr({ direction: l }));
            else
        ...
        drawPlotZoomlineGraphics: function(b, c, f, h, k, q, r) {
            ...
            k = function(a, b) { var c = a && a.length,
                    d = Math.max.apply(Math, a),
                    e = Math.min.apply(Math, a),
                    f = 0; if (d > g || e < G)
                    for (; f < c;) { e = a[f]; if (e > g || e < G) d = b + f, Da(e, d, d, !0);
                        f += 1 } };
            for (Da = function(a, f, g, k) {
                    ...
                    Y = g * ma;
                    aa = Y - ha;
                    if (void 0 === (W = c[f])) { if (Q) ia = "M", qa = ea, aa = Y - ha, va = ea;
                        else { if (0 === Aa) { for (m = f; 0 < m && (--m, p = c[m], void 0 === p););
                                p && (Y = m * ma * -1, qa = ea, N[ya++] = ia, N[ya++] = Y, N[ya++] = va = (p - b._yminValue) * ka, ia = "L") } if (f === L) { for (m = f; m < P && (m += 1, t = c[m], void 0 === t););
                                t && (Y = m * ma, qa = ea, N[ya++] = ia, N[ya++] = Y, N[ya++] = va = (t - b._yminValue) * ka, ia = "L") } }
                        n++ } else N[ya++] = ia, V ? (V = !1, N[ya++] = qa = aa = X * ma / (ba * w) * f) : u ? (u = !1, ba >= f - X && (N[ya - 1] = "L"), b.pppCopy =
                ...
                Fa = a;
                if (I)
                    if (0 === a && void 0 === c[a]) { w = 0; for (B = X = a; B < Ea;)
                            if (void 0 !== c[B] || m ? m = !0 : B++, void 0 === c[X] && !Ba && X <= Ea ? (X += ba, w++) : Ba = !0, m && Ba) { m = Ba = !1; break }
                        0 !== B % ba && (V = !0, ta = c[B], Fa = B) } else if (a >= Ea && void 0 === c[a]) {
            ...
            z || function(a, b,
                c) { var e = c.plotName;
                f.tooltipListenerAttached || (f.tooltipListenerAttached = !0, f.mousemove(function(c) { var h = a._zoominfo,
                        g = a._visx,
                        k = h.step,
                        m = h.ppp * k;
                    c = ab(a.container, c).chartX - g; var n, g = E.tooltipSepChar;
                    c = (c += m / 2 + h.offset) - c % m;
                    n = (n = a.getValuePixel(c)) + n % k;
                    d = a.getParsedLabel(n) + g + l.yAxis(b[n]);
                    d = e && e + g + d || d;
                    f.tooltip(d) })) }(this, c, b)
        },
        legendClick: function(b) { var c = !b.visible,
                f = c ? "show" : "hide";
            b.group[f]();
            b.anchorGroup[f]();
            this.base.legendClick.apply(this, arguments); return b.visible = c },
        dispose: function() {
            var b;
    ...
    Ca = function(b, c) {
        ...
        this.getDataIndexFromPixel = function(c) { return b.getValuePixel(c) };
        this.getPositionLabel = function(c) { return b.getParsedLabel(c) };
        if (c.valueEnabled) { r = 0; for (x = l.length; r < x; r++) I = l[r], I = I.graphic.attrs.stroke, k.push(f.text(0, A, "", z).css(t).attr({ fill: I, direction: h.textDirection, "text-bound": ["rgba(255,255,255,0.8)", "rgba(0,0,0,0.2)", 1, 2.5] }));
            this.numberFormatter = b.numberFormatter }
    };
    Ca.prototype.disable = function(b) { void 0 !== b && (this.disabled = !!b) && this.visible && this.hide(); return this.disabled };
    Ca.prototype.onMouseOut = function() { this.hide() };
    Ca.prototype.onMouseDown = function() {!Oa && this.hide();
        this._mouseIsDown = !0 };
    Ca.prototype.onMouseUp = function() {!Oa && this.hide();
    ...
    Ca.prototype.updateLabels = function() {
        var b = this,
            ...
            N = function() {
                ...
                function f(b) { for (var c = 0; c < b;) this.push(c++); return this }

                function h(b) { var c, f, g, k, l = Number.POSITIVE_INFINITY; for (c = 0; c < this.length; c++) f = this[c] - b, 0 > f ? g = I.NEG : g = I.POS, f = G(f), f <= l && (l = f, k = { absValue: f, noScaleSide: g }); return k }

                function g(b) { this.holes = f.call([], b) }
                var k = -1 * b.height,
                    q = l * x,
                    r = 0,
                    t, A = {},
                ...
                Array.prototype.indexOf || (Array.prototype.indexOf = function(b, c) {
                    ...
                    for (f = Math.max(0 <= f ? f : g - Math.abs(f),
                            0); f < g;) { if (f in h && h[f] === b) return f;
                        f++ }
                    return -1
                });
                Array.prototype.forEach || (Array.prototype.forEach = function(b, c) { var f, h, g, k, l; if (null == this) throw new TypeError(" this is null or not defined");
                    g = Object(this);
                    k = g.length >>> 0; if ("function" !== typeof b) throw new TypeError(b + " is not a function");
                    1 < arguments.length && (f = c); for (h = 0; h < k;) h in g && (l = g[h], b.call(f, l, h, g)), h++ });
                c.prototype.constructor = c;
                c.prototype.applyShift = function(b) { this.__shift = b;
                    this.lRef.calcY = this.y += b * r };
                c.prototype.applyDirectIndex =
                    function(b) { this.__index = b;
                        this.lRef.calcY = this.y = k - b * r * -1 };
                try { Object.defineProperty(I, "POS", { enumerable: !1, configurable: !1, get: function() { return 1 } }), Object.defineProperty(I, "NEG", { enumerable: !1, configurable: !1, get: function() { return -1 } }) } catch (W) { I.POS = 1, I.NEG = -1 }
                g.prototype = Object.create(Array.prototype);
                g.prototype.constructor = g;
                g.prototype.repositionHoles = function() { var b, c = 0,
                        f; for (b = this.holes.length = 0; b < this.length; b++) f = this[b], !f && (this.holes[c++] = b) };
                g.prototype.attachShift = function(b, f,
                    ...
                    if (b === E) g.calcY = E;
                        ...
                        if (b.noScaleSide === I.NEG) {
                            ...
                            this.pop();
                            b.forEach(function(b) { b && b.applyShift(-1) });
                ...
                try { Object.defineProperty(A, "top", { enumerable: !1, configurable: !1, get: function() { return k } }), Object.defineProperty(A, "bottom", { enumerable: !1, configurable: !1, get: function() { return q } }) } catch (W) { A.top = k, A.bottom = q }
                A.init = function(b, c) { var f;
                    r = b + 2;
                    k += r / 2;
                    z = R(G(k) / r);
                    t = new g(z); for (f = 0; f < z; f++) t.push(0) };
        ...
        c && (c[0].attr({ text: z.yAxis("0") }), N.init(c[0].getBBox().height, c.length), c.forEach(function(b, c) { var h = f[c],
                l = h.data[k],
                q = h.yAxis;
            N.occupy(void 0 === l || !h.visible || (q ? l > G || l < g : l > t || l < I) ? E : q ? (l - g) * A : (l - I) * x, b) }));
        c && c.forEach(function(b, c) { var g;
    ...
    Ca.prototype.show = function() { this.disabled || (this.hidden = !1, this.group.attr("visibility", "visible"), this.line.attr("visibility", "visible"), this.positionLabel && this.positionLabel.attr("visibility", "visible")) };
    Ca.prototype.hide = function() { this.hidden = !0;
        this.group.attr("visibility", "hidden");
        this.line.attr("visibility", "hidden");
        this.positionLabel && this.positionLabel.attr("visibility", "hidden") };
    Ca.prototype.dispose = function() { for (var b in this) this.hasOwnProperty(b) && delete this[b] };
    k.addSymbol({
        pinModeIcon: function(b,
            c, f) { var h = .5 * f,
                ...
                I = c + h,
                t = c - h,
                h = c + (f - h); return ["M", k, L, "L", r, t, r, h, k, I, b - .5, I, b, c + f + .5, A, I, q, I, x, h, x, t, q, L, z, L, z, t, z, h, l, h, l, t, z, t, z, L, "Z"] },
        zoomOutIcon: function(b, c, f) { b -= .2 * f;
            c -= .2 * f; var h = .8 * f,
                q = k.rad(43),
                z = k.rad(48),
                r = b + h * qa(q),
                ...
                E = q + f * Ea(A),
                L = x + f * qa(A);
            f = z + f * Ea(A); return ["M", r, q, "A", h, h, 0, 1, 0, x, z, "Z", "M", r + 1, q + 1, "L", l, E, L, f, x + 1, z + 1, "Z", "M", b - 2, c, "L", b + 2, c, "Z"] },
