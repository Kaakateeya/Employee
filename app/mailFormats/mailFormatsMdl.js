(function() {
    ...
    function factory(mailFormatsService) {
        ...
        model.paidPartialviewfull = [
            ...
            [{ "TableName": "About My Family", "columnname": "Father Name", "value": "Subba Reddy (LATE), dwwwwwwww" }, { "TableName": "About My Family", "columnname": "Father Profession", "value": "Business" }, { "TableName": "About My Family", "columnname": "Father Father Name", "value": "KRISHNAREDDY(LATE)" }, { "TableName": "About My Family", "columnname": "Father Native District", "value": "y s r, AP<br><br>" }, { "TableName": "About My Family", "columnname": "Mother Name", "value": "Annapurna " }, { "TableName": "About My Family", "columnname": "Mother Father Name", "value": "SUBBIREDDY" }, { "TableName": "About My Family", "columnname": "Mother Native District", "value": "y s r, AP<br><br>" }, { "TableName": "About My Family", "columnname": "No of Siblings", "value": "No Of Brothers: 1    No Of Sisters: 1" }],
            ...
            [{ "TableName": "My Father side & Mother side Family", "ColumnName": "Father Brother (Elder)", "Value": "Available" }, { "TableName": "My Father side & Mother side Family", "ColumnName": "Father Sister (Elder)", "Value": "Available" }],
            [{ "TableName": "My Mother side Family", "ColumnName": "MotherBrother(Elder)", "Value": "Available" }],
        ...
        model.arrayviewprofile = [
            ...
            [{ "TableName": "My Father side & Mother side Family", "ColumnName": "Father Brother (Elder)", "Value": "Sambasiva Rao, Farmer, 28asha88@gmail.com, Remalle " }, { "TableName": "My Father side & Mother side Family", "ColumnName": "Father Brother (Elder)", "Value": "Veerabhadra Rao, Farmer, 28asha88@gmail.com, Remalle " }, { "TableName": "My Father side & Mother side Family", "ColumnName": "Father Sister (Elder)", "Value": "Lakshmi Samrajyam&nbsp;&nbsp;<b>W/O:</b> Kondasani Pitcheswara Rao (Late ), Agriculture, <b>Native: </b>Eedulagudem, Krishna, AP , <b>Current Location: </b>Eedulagudem" }],
            [],
            [],
