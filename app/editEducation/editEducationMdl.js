(function(angular) {
    ...
    function factory($http, authSvc, editEducationService, commonFactory, uibModal, filter, alertss, stateParams, SelectBindService, arrayConstantsEdit, SelectBindServiceApp) {
        ...
        model.Custdata = [
            ...
            { lblname: 'Religion', controlType: 'select', ngmodel: 'religionId', secondParent: 'religionId', firstparent: 'motherTongueId', required: true, typeofdata: 'Religion', childName: 'caste', changeApi: 'castedependency', parameterValue: 'ReligionID' },
            { lblname: 'Mother Tongue', controlType: 'select', ngmodel: 'motherTongueId', secondParent: 'religionId', firstparent: 'motherTongueId', required: true, typeofdata: 'Mothertongue', childName: 'caste', changeApi: 'castedependency', parameterValue: 'MotherTongueID' },
