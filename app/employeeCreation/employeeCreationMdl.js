            ...
            function(employeeCreationService, commonFactory, Commondependency, gridConfig, alertss, modelpopupopenmethod, fileUpload, timeout, helperservice, window) {
                ...
                model.reset = function() {
                    ...
                    if (model.selectedIndex === 1) {
                        ...
                        model.dependencyChange(1, 'state');

                        model.branchArrSelect = [];
                        model.branchArrSelect.push({ "label": "--select--", "title": "--select--", "value": '' });
                        model.branchArrSelect = model.branchArrSelect.concat(model.branchArr);
